...
# built on TensorFlow ResNetV1 and resnet_v1 by:
...
# _scope is configured to use with the resnet_v1_50 from TensorFlow
class resnetv1_41(Network):
  ...
  def _decide_blocks(self):
    ...
    if self._num_layers == 41:
      self._blocks = [resnet_v1_block('block1', base_depth=64, num_units=3, stride=2),
                      ...
                      resnet_v1_block('block3', base_depth=256, num_units=4, stride=1),
